window.DESIGN_ANNOTATIONS_DATA = {
  pages: [
    { id: "onboarding", label: "AR0223 — Onboarding", route: "index.html" },
  ],
  ...
  annotations: [
    ...
    },
    {
      ...
      page: "onboarding",
      kind: "suggestion",
      title: "This experiment is a pivot away from AR0227's fake-app-window approach — now down to 2 screens and a 2-item story",
      description:
        "AR0227's Step 2 mimicked the real desktop app in a browser mockup (traffic-light titlebar, a fake play button, a fake counting timer) — feedback was that this made it look like you could actually track time from the web page, when tracking can only ever happen in the real desktop app. AR0223 started as a duplicate of AR0227 with that idea replaced by a 3-step \"story\" (Download → Open the app → Press play) plus an honest \"Waiting to hear back from your desktop app…\" status line. It has since dropped AR0227's separate \"Download the desktop app\" screen entirely, and — matching the final Figma hand-off (AR0227 — Aggressive track version) — also dropped the middle \"Open Hubstaff\" item, since it had no distinct signal to promote it to active on its own. The story is now just 2 items: Download the app → Press play to start the timer. This experiment is 2 screens total: the setup story (with download folded in), then \"Get familiar with Hubstaff.\"",
      target: ".setup-story",
